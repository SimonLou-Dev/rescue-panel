                ...
                <div className={'list-content'}>
                    ...
                    <div className={'list'}>
                        {this.state.patients !== null && this.state.patients.map((patient)=>
                            <PatientListPU name={patient.name} date={dateFormat(patient.created_at, 'HH:mm')} patient_id={patient.id} urlid={patient.rapport_id} color={patient.get_color.name} idcard={patient.idcard}/>
                        )}
                    </div>
                </div>
            </section>
